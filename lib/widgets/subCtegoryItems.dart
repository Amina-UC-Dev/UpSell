...
class SubCategoryItems extends StatelessWidget {
  const SubCategoryItems({Key? key}) : super(key: key);
                        ...
                        Stack(
                          ...
                          children: [
                            Stack(alignment: Alignment.bottomCenter,
                              children: [
                                Container(height: 170,child: Image.asset("assets/shopByCat.jpg",fit: BoxFit.cover,),width: w/3),
                                Padding(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 7,vertical: 1),
                                child: Text("",style: CommonTextStyle().style1(font: 12, weight: FontWeight.w400, color: white),),
                              ),
                            )
                          ],
                        ),
